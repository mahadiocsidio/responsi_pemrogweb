...
import WatermelonJSON from "/public/img/animation_ljzeixmi.json";
    ...
    <nav class="bg-gray-900">
        ...
        >
            <a href="/" class="flex items-center">
                <img src="img/sensor.png" class="h-10 mr-3" alt=" Logo" />
                <span
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-900 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-grey-800 dark:bg-gray-900 dark:border-gray-700"
                >
                    <li>
                        <a
                            href="#"
